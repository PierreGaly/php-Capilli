...
$tableauTitle['annonce_nouvelle'] = 'prendre un rendez-vous';
...
return $titre . SITE_NOM . ' - location de biens et échange de services entre étudiants';
}
...
<meta name="keywords" content="location, étudiant, lok, loc, club, service, particulier, échange, plateforme, parrainage, annonces, biens" />
<?php
if($this->nom_fichier == 'index')
echo '<meta name="description" content="' . SITE_NOM . ' est une plateforme de location de biens et d\'échange de services entre étudiants." />';
...
<li>
<a href="panier.php" role="button"><span class="glyphicon glyphicon-scissors" aria-hidden="true"></span><span class="hidden-xs hidden-sm"> Espace coiffeur</span><?php
$quantite_panier = 0;
...
{
?>
<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><span class="glyphicon glyphicon-user" aria-hidden="true"></span><span class="hidden-xs hidden-sm"> <span id="sidentifier" style="width: 86px; display: inline-block;">Se connecter</span> </span><span class="caret"></span></a>
...
<span style="font-size: 1.05em; padding-left: 60px;">
</span>
