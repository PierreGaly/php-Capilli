...
<div class="row">
	<div class="row_content">
		...
		<h2>Je m'inscris<span class="small"><br />en 2 minutes</span></h2>
		...
		if($erreurs)
		{
			...
			else if($erreurs['source'])
				echo '<div class="alert alert-danger text-center" role="alert">Veuillez nous renseigner comment vous avez connu notre plateforme.</div>';
		...
		<div class="row">
			...
			<form class="form-horizontal" role="form" enctype="multipart/form-data" action="" method="post">
				...
				<fieldset>
					...
					<div class="form-group form-inline">
						<label class="control-label col-sm-4" for="inscription_type">Type de compte</label>
						<div class="col-sm-8">
							<select name="inscription_type" id="inscription_type" class="form-control">
								<option value="particulier"<?php if(isset($_POST['inscription_type']) && $_POST['inscription_type'] == 'particulier') echo ' selected'; ?>>Particulier</option>
								<option value="professionnel"<?php if(isset($_POST['inscription_type']) && $_POST['inscription_type'] == 'professionnel') echo ' selected'; ?>>Professionnel</option>
							</select>
						</div>
					</div>
					...
					<div class="form-group">
						<label class="control-label col-sm-4" for="inscription_pseudo">D'où connaissez-vous notre plateforme ?</label>
						<div class="col-sm-8">
							<select class="form-control" id="inscription_source" name="inscription_source" required>
								<option value="0">Sélectionnez une source</option>
								<?php
								...
								foreach($sources as $source)
								{
									...
									if(isset($_POST['inscription_source']) && $_POST['inscription_source'] == $source->ID)
										echo ' selected';
									
									echo '>' . htmlspecialchars($source->source) . '</option>';
								}
								?>
							</select>
						</div>
